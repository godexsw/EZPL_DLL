...
Public Class clsPrinterCommand
    ...
    Private Shared Sub GetBarcodeTypeHash()
        ...
        If clsPrinterCommand.BarcodeTypeHash.Count <= 0 Then
            clsPrinterCommand.BarcodeTypeHash(BarCodeType.Code39_Extended) = "A"
            clsPrinterCommand.BarcodeTypeHash(BarCodeType.Code39_Extended_CheckDidit) = "A2"
            clsPrinterCommand.BarcodeTypeHash(BarCodeType.Code39) = "A3"
            clsPrinterCommand.BarcodeTypeHash(BarCodeType.Code39_CheckDidit) = "A4"
            clsPrinterCommand.BarcodeTypeHash(BarCodeType.EAN8) = "B"
            clsPrinterCommand.BarcodeTypeHash(BarCodeType.EAN8_Add2) = "C"
            clsPrinterCommand.BarcodeTypeHash(BarCodeType.EAN8_Add5) = "D"
            clsPrinterCommand.BarcodeTypeHash(BarCodeType.EAN13) = "E"
            clsPrinterCommand.BarcodeTypeHash(BarCodeType.EAN13_Add2) = "F"
            clsPrinterCommand.BarcodeTypeHash(BarCodeType.EAN13_Add5) = "G"
            clsPrinterCommand.BarcodeTypeHash(BarCodeType.UPCA) = "H"
            clsPrinterCommand.BarcodeTypeHash(BarCodeType.UPCA_Add2) = "I"
            clsPrinterCommand.BarcodeTypeHash(BarCodeType.UPCA_Add5) = "J"
            clsPrinterCommand.BarcodeTypeHash(BarCodeType.UPCE) = "K"
            clsPrinterCommand.BarcodeTypeHash(BarCodeType.UPCE_Add2) = "L"
            clsPrinterCommand.BarcodeTypeHash(BarCodeType.UPCE_Add5) = "M"
            clsPrinterCommand.BarcodeTypeHash(BarCodeType.I2of5) = "N"
            clsPrinterCommand.BarcodeTypeHash(BarCodeType.I2of5_CheckDigit) = "N2"
            clsPrinterCommand.BarcodeTypeHash(BarCodeType.Codabar) = "O"
            clsPrinterCommand.BarcodeTypeHash(BarCodeType.Code93) = "P"
            clsPrinterCommand.BarcodeTypeHash(BarCodeType.Code128_Auto) = "Q"
            clsPrinterCommand.BarcodeTypeHash(BarCodeType.Code128_Subset) = "Q2"
            clsPrinterCommand.BarcodeTypeHash(BarCodeType.UCC_128) = "R"
            clsPrinterCommand.BarcodeTypeHash(BarCodeType.PostNET) = "S"
            clsPrinterCommand.BarcodeTypeHash(BarCodeType.ITF14) = "T"
            clsPrinterCommand.BarcodeTypeHash(BarCodeType.EAN128) = "U"
            clsPrinterCommand.BarcodeTypeHash(BarCodeType.RPS128) = "V"
            clsPrinterCommand.BarcodeTypeHash(BarCodeType.HIBC) = "X"
            clsPrinterCommand.BarcodeTypeHash(BarCodeType.MSI_1MOD10) = "Y"
            clsPrinterCommand.BarcodeTypeHash(BarCodeType.MSI_2MOD10) = "Y2"
            clsPrinterCommand.BarcodeTypeHash(BarCodeType.MSI_1MOD1110) = "Y3"
            clsPrinterCommand.BarcodeTypeHash(BarCodeType.MSI_NoDigitCheck) = "Y4"
            clsPrinterCommand.BarcodeTypeHash(BarCodeType.I2of5_ShippingBearerBars) = "Z"
            clsPrinterCommand.BarcodeTypeHash(BarCodeType.UCC_EAN128_KMART) = "1"
            clsPrinterCommand.BarcodeTypeHash(BarCodeType.UCC_EAN128_RANDOM) = "2"
            clsPrinterCommand.BarcodeTypeHash(BarCodeType.Telepen) = "3"
            clsPrinterCommand.BarcodeTypeHash(BarCodeType.FIM) = "4"
            clsPrinterCommand.BarcodeTypeHash(BarCodeType.Plessey) = "7"
        End If
    ...
    Public Function PrintBarCode(ByVal mBarCodeType As BarCodeType, ByVal PosX As Integer, ByVal PosY As Integer, ByVal Data As String) As Integer
        clsPrinterCommand.GetBarcodeTypeHash()
        Return EZioApi.Bar_S(clsPrinterCommand.BarcodeTypeHash(mBarCodeType).ToString(), PosX, PosY, Data)
    End Function
    ...
    Public Function PrintBarCode(ByVal mBarCodeType As BarCodeType, ByVal PosX As Integer, ByVal PosY As Integer, ByVal Narrow As Integer, ByVal Wide As Integer, ByVal Height As Integer, ByVal Rotation As Integer, ByVal Raedable As Integer, ByVal Data As String) As Integer
        clsPrinterCommand.GetBarcodeTypeHash()
        Return EZioApi.Bar(clsPrinterCommand.BarcodeTypeHash(mBarCodeType).ToString(), PosX, PosY, Narrow, Wide, Height, Rotation, Raedable, Data)
    End Function
...
Public Class GodexPrinter
    ...
    Public Command As clsPrinterCommand = New clsPrinterCommand()
